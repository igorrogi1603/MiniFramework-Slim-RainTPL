...
class Validacao {
	...
	public function replaceDigitoRg($rg)
	{
		...
		$rgProvisorio2 = str_replace("-", "", $rgProvisorio);

		//pegar apenas o digito do rg
		return substr($rgProvisorio2, 8, 1);
	}
	...
	{	
		...
		//pegar apenas o digito do rg
		return substr($rgProvisorio2, 0, 8);
	}
	...
	public function replacePrecoBd($preco)
	{
		$precoProvisorio = str_replace(",", ".", $preco);

		return $precoProvisorio;
	}
	...
	public function replaceSexo($sexo)
	{
		if ($sexo == 'm' || $sexo == 'M') {
			return "Masculino";
		}
